    ...
    var _ = (w.SHA512 = o.extend({
      ...
      _doProcessBlock: function (i, h) {
        for (
          ...
          var Z = f[Y];
          if (Y < 16)
            var $ = (Z.high = 0 | i[h + 2 * Y]),
              ii = (Z.low = 0 | i[h + 2 * Y + 1]);
          else {
            var hi = f[Y - 15],
              oi = hi.high,
              ei = hi.low,
              ...
              li = ri.high,
              ai = ri.low,
              wi = ((li >>> 19) | (ai << 13)) ^ ((li << 3) | (ai >>> 29)) ^ (li >>> 6),
              si = ((ai >>> 19) | (li << 13)) ^ ((ai << 3) | (li >>> 29)) ^ ((ai >>> 6) | (li << 26)),
              gi = f[Y - 7],
              ci = gi.high,
              fi = gi.low,
              di = f[Y - 16],
              ui = di.high,
              vi = di.low;
            $ = ($ = ($ = ni + ci + ((ii = ti + fi) >>> 0 < ti >>> 0 ? 1 : 0)) + wi + ((ii = ii + si) >>> 0 < si >>> 0 ? 1 : 0)) + ui + ((ii = ii + vi) >>> 0 < vi >>> 0 ? 1 : 0);
            Z.high = $;
            Z.low = ii;
          }
          var pi,
          ...
          K =
            (G +
              (ji =
                (ji = (ji = ji + Hi + ((pi = pi + yi) >>> 0 < yi >>> 0 ? 1 : 0)) + zi + ((pi = pi + Wi) >>> 0 < Wi >>> 0 ? 1 : 0)) +
                $ +
                ((pi = pi + ii) >>> 0 < ii >>> 0 ? 1 : 0)) +
              ((L = (I + pi) | 0) >>> 0 < I >>> 0 ? 1 : 0)) |
            0;
...
if ('object' == typeof exports) module.exports = exports = h(require('./663'), require('./664'));
